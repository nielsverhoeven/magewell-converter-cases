...
MCC_DEV_PRO_CONVERT_FOR_NDI_TO_AIO = [
    ...
    ["ports", [
        ...
        // Top layout follows the shared decoder pattern (knowledge/magewell/models/pro-convert-for-ndi-to-aio.md:23),
        // not independently photographed for this model — confidence "assumed", not "photo".
