...
//   openscad --backend=Manifold -D 'part="NE8FDP-B"' -o out/neutrik-tile-ne8fdp.stl models/coupons/neutrik-tile.scad
//////////////////////////////////////////////////////////////////////
...
// -D part="..." switches the connector class, e.g. -D part="NE8FDP-B" for the 24.0-class hole.
part = "NAHDMI-W-B";
...
echo(str(
    "neutrik-tile: part=\"", part, "\" size=", TILE_SIZE, " t=", TILE_T, " seat_t=", SEAT_T,
    " cutout_d=", mcc_cutout_d(part), " bay_depth=", mcc_bay_depth(part)
));
...
difference() {
    ...
    mcc_panel_cutout(part, seat_t = SEAT_T, panel_t = TILE_T);

    // Engraved (recessed) part-name label near one edge.
    translate([0, -TILE_SIZE[1] / 2 + 5, TILE_T - 0.6])
        linear_extrude(height = 0.6 + MCC_EPS)
            text(part, size = LABEL_SIZE, halign = "center", valign = "center", font = "Liberation Sans:style=Bold");
}
