//////////////////////////////////////////////////////////////////////
// models/pro-convert-for-ndi-to-aio/case.scad
...
//   .claude/knowledge/layout-patch-wall.md §16, GitHub issue #9). part in {"base","lid","panel",
//   "assembly","ghost_device","ghost_plugs"}; only base/lid/panel are ever picked up by
//   scripts/build.py (discover_models() hardcodes ["base","lid"] + "panel" iff the literal
//   substring 'part == "panel"' appears below).
// Render:
//   openscad --backend=Manifold -D 'part="base"' -o out/base.stl models/pro-convert-for-ndi-to-aio/case.scad
//////////////////////////////////////////////////////////////////////
...
// from this case, remove/edit it in lib/mcc/devices/pro-convert-for-ndi-to-aio.scad instead
...
dev = MCC_DEV_PRO_CONVERT_FOR_NDI_TO_AIO;
...
echo(str("pro-convert-for-ndi-to-aio: L=", L_dims[0], " W=", L_dims[1], " H=", L_dims[2]));
echo(str("pro-convert-for-ndi-to-aio: slots=", mcc_slot_assignment(dev)));
